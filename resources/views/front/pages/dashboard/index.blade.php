                    ...
                    <div class="settings-widget dash-profile mb-3">
                        <div class="settings-menu p-0">
                            <div class="profile-bg">
                                <h5>Beginner</h5>
                                <img src="{{ asset('/') }}assets/front/img/profile-bg.jpg" alt="">
                                <div class="profile-img">
                                    <a href="student-profile.html"><img
                                          src="{{ asset('/') }}assets/front/img/user/user11.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="profile-group">
                                ...
                                <div class="go-dashboard text-center">
                                    <a href="deposit-student-dashboard.html" class="btn btn-primary">Go to
                                        Dashboard</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-menu p-0">
                            ...
                            <div class="course-group mb-0 d-flex">
                                <div class="course-group-img d-flex align-items-center">
                                    <a href="student-profile.html"><img
                                          src="{{ asset('/') }}assets/front/img/user/user11.jpg" alt=""
                                          class="img-fluid"></a>
