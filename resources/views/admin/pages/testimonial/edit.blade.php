                      ...
                      enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input required type="text" class="form-control input-default " name="title"
                              placeholder="Type Here ... " value="{{ $testimonial->title }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" class="form-control input-default " name="name"
                              placeholder="Type Here ... " value="{{ $testimonial->name }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="text" class="form-control input-default "
                              value="">{{ $testimonial->text }}</textarea>
                        </div>
